...
if (KDCRAW_INCLUDE_DIR AND KDCRAW_LIBRARIES AND KDCRAW_DEFINITIONS AND KDCRAW_VERSION)
  ...
  if (KDCRAW_LOCAL_DIR)
    find_file(KDCRAW_LOCAL_FOUND libkdcraw/version.h.cmake.in ${CMAKE_SOURCE_DIR}/${KDCRAW_LOCAL_DIR} NO_DEFAULT_PATH)
    ...
    find_file(KDCRAW_LOCAL_FOUND libkdcraw/version.h.cmake.in ${CMAKE_SOURCE_DIR}/libkdcraw NO_DEFAULT_PATH)
    if (KDCRAW_LOCAL_FOUND)
      set(KDCRAW_LOCAL_DIR libkdcraw)
    endif (KDCRAW_LOCAL_FOUND)
    find_file(KDCRAW_LOCAL_FOUND libkdcraw/version.h.cmake.in ${CMAKE_SOURCE_DIR}/libs/libkdcraw NO_DEFAULT_PATH)
    if (KDCRAW_LOCAL_FOUND)
