...
enum LibRaw_warnings
{
    ...
    LIBRAW_WARN_FOVEON_INVALIDWB =2,
...
enum LibRaw_progress
{
    ...
    LIBRAW_PROGRESS_RESERVED_PRE1       = 1<<5,
    LIBRAW_PROGRESS_RESERVED_PRE2       = 1<<6,
    ...
    LIBRAW_PROGRESS_CONVERT_RGB         = 1<<16,
    LIBRAW_PROGRESS_STRETCH             = 1<<17,
// reserved
    LIBRAW_PROGRESS_STAGE18             = 1<<18,
